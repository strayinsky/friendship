...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.color'
        db.add_column(u'friends_profile', 'color',
                      self.gf('django.db.models.fields.CharField')(default='red', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.color'
        db.delete_column(u'friends_profile', 'color')
    ...
    models = {
        ...
        u'friends.profile': {
            ...
            'activities': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['friends.Activity']", 'null': 'True', 'symmetrical': 'False'}),
